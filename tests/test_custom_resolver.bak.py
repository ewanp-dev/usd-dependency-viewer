"""
NOTE
* WE ARE GETTING THE RIGHT AMOUNT OF DEPENDENCIES HERE BUT ONLY AFTER REMOVING
DUPLICATES, WE NEED TO FIND A WAY TO REMOVE THE DUPLICATES IN THE RECURSIVE FUNCTION
"""
